...
FROM dwolla/jenkins-agent-mono:$MONO_TAG
LABEL maintainer="Dwolla Dev <dev+jenkins-mono-sbt@dwolla.com>"
LABEL org.label-schema.vcs-url="https://github.com/Dwolla/jenkins-agent-docker-mono-sbt"
